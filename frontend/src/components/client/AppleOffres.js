...
const JobOfferModal = ({ show, handleClose, offre }) => {
  ...
  const [dataTableInstance, setDataTableInstance] = useState(null); // Stocker l'instance de DataTable
  ...
  //       `http://localhost:8000/appels_offres/api/offres/${formData.id}/`,
  //       formData,
  //       {
  ...
  const saveJobOffer = async () => {
    ...
    try {
      const response = await axiosInstance.put(
        `/appels_offres/api/offres/${formData.id}/`,
        formData
      );
      setSaveSuccess(true);
    } catch (error) {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `/appels_offres/api/documents/${offre.id}/`
      );
  ...
  const handleDocumentSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/appels_offres/ajouter_document_client/${offre.id}/`,
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        // setMessage("Document ajoutée avec succès !");
  ...
  const deleteDocument = async (documentId) => {
    ...
    try {
      const response = await axiosInstance.delete(
        `/appels_offres/api/documents/delete/${documentId}/`
      );
          ...
          <Tab.Content>
              ...
              <Form onSubmit={(e) => handleSubmit(e, "tab1")}>
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="form-label-custom">
                    Titre <span style={{ color: "black" }}>*</span>
                  </Form.Label>
                  <Editor
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="form-label-custom">
                    Description <span style={{ color: "black" }}>*</span>
                  </Form.Label>
                  <Editor
                    apiKey="klj83yy4j4btu0s11oheti6rj6kwwgj0lnbtwunqvvqeipyf"
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      <Form.Label className="form-label-custom">
                        Date limite <span style={{ color: "black" }}>*</span>
                      </Form.Label>
                      <Form.Control
                        type="date"
                        name="date_limite"
                ...
                {/* Lieu & Titre entreprise */}
                <Row>
                  <Col md={6} style={{ paddingRight: "20px" }}>
                    <Form.Group className="mb-3">
                      <Form.Label className="form-label-custom">
                        Lieu <span style={{ color: "black" }}>*</span>
                      </Form.Label>
                      <Form.Select
                        name="lieu"
                        value={formData.lieu}
                ...
                {/* Titre documents & Groupement spécial */}
                <Row>
                  <Col md={6} style={{ paddingRight: "20px" }}>
                    <Form.Group className="mb-3">
                      <Form.Label className="form-label-custom">
                ...
                {/* Titre groupement & Arabe */}
                <Row>
                  <Col md={6} style={{ paddingRight: "20px" }}>
                    <Form.Group className="mb-3">
                      <Form.Label className="form-label-custom">
                        Titre groupement spécial{" "}
                        <span style={{ color: "black" }}>*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      <Form.Label className="form-label-custom">
                        Titre groupement spécial arabe{" "}
                        <span style={{ color: "black" }}>*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
            ...
            <Tab.Pane eventKey="tab2">
              <Form onSubmit={(e) => handleSubmit(e, "tab2")}>
                <Form.Group className="mb-3">
                  ...
                  >
                    Titre en arabe <span className="">*</span>
                  </Form.Label>
                  <Form.Control
                    type="text"
                    name="titre_ar"
                ...
                <Row>
                  <Col md={6} style={{ paddingRight: "15px" }}>
                    <Form.Group className="mb-3 ms-2">
                      <Form.Label
                        ...
                        style={{ fontSize: "16px", color: "#858796" }}
                      >
                        Titre entreprise ar <span className="">*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                  ...
                  <Col md={6} style={{ paddingRight: "13px" }}>
                    <Form.Group className="mb-3">
                      <Form.Label
                        className=""
                        style={{ fontSize: "16px", color: "#858796" }}
                      >
                        Titre des documents en arabe <span className="">*</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                ...
                <Form.Group className="mb-3 ">
                  <Form.Label
                    ...
                    style={{ fontSize: "16px", color: "#858796" }}
                  >
                    Description en arabe <span className="">*</span>
                  </Form.Label>
                  <Editor
                    apiKey="klj83yy4j4btu0s11oheti6rj6kwwgj0lnbtwunqvvqeipyf"
                ...
                <Form.Group className="mb-3">
                  <Form.Label
                    ...
                    style={{ fontSize: "16px", color: "#858796" }}
                  >
                    Message Ar <span className="">*</span>
                  </Form.Label>
                  <Editor
                    apiKey="klj83yy4j4btu0s11oheti6rj6kwwgj0lnbtwunqvvqeipyf"
            ...
            <Tab.Pane eventKey="tab3">
              <section className="container mt-4">
                ...
                {/* Card Formulaire affichée au-dessus de la table */}
                {showCard && (
                  <div className="d-flex justify-content-center">
                    ...
                    >
                      ...
                      >
                        <h5 className="mb-0">Nouveau document</h5>
                        <Button
...
const AppleOffres = ({ appleOffres = [], clientId }) => {
  ...
  const [typeAnnonce, setTypeAnnonce] = useState("Internationaux");
  ...
  const filterAppels = () => {
    const etat = $("#etat").val();
    const type = $("#type").val();
    const table = $("#appleOffresTable").DataTable();

    table.columns().search("").draw();

    if (etat !== "all") {
      if (etat === "2") {
        table.column(5).search("false").draw(); // si_valider = false
      } else if (etat === "3") {
        table.column(5).search("true").draw(); // si_valider = true
      } else if (etat === "10") {
        table.column(6).search("true").draw(); // si_archiver = true
      }
    }
    ...
    if (type !== "all") {
      ...
      switch (type) {
        case "3":
          typeValue = "Internationaux";
          break;
        case "4":
          typeValue = "Locaux";
          break;
        case "5":
          typeValue = "Consultations";
          break;
        case "6":
          typeValue = "Manifestations";
          break;
        default:
          typeValue = "";
      }
      table.column(2).search(typeValue).draw();
    }
  };
    ...
    if (appleOffres.length > 0) {
      const table = $("#appleOffresTable").DataTable({
        ...
        columns: [
          ...
          { data: "type_offre", defaultContent: "Internationaux" },
          { data: "client__nom", defaultContent: "" },
          {
            data: null,
            orderable: false,
      ...
      $("#appleOffresTable tbody").on("click", "button", function () {
        const offreId = $(this).data("id");
        const action = $(this).data("action");
        const offre = appleOffres.find((o) => o.id === offreId);
      ...
      const initializeSelectpicker = () => {
        if ($.fn.selectpicker) {
          ...
          console.warn("Bootstrap Selectpicker not available.");
        }
      };
  ...
  return (
    <section className="container mt-4">
        ...
        >
          <div className="filter">
            <div className="row">
              ...
              <div className="col-sm-6 col-md-3 filters-item ms-3">
                <div
                  className="filters-label mb-2"
                  style={{
                    display: "flex",
                ...
                <div className="filters-input">
                  ...
                  >
                    <option value="all">Tous</option>
                    <option value="3">Appels d'offres internationaux</option>
                    <option value="4">Appels d'offres locaux</option>
                    <option value="5">Consultations</option>
                    <option value="6">Manifestations d’Intérêts</option>
                  </select>
                  <i
                    className="fas fa-caret-down fa-sm"
                    style={{
      ...
      <Modal show={showAddModal} onHide={handleCloseAddModal} size="xl">
        <Modal.Header closeButton>
          <Modal.Title style={{ color: "#858796" }}>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              >
                <option value="Internationaux">
                  Appels d'offres internationaux
                </option>
                <option value="Locaux">Appels d'offres locaux</option>
                <option value="Consultations">Consultations</option>
                <option value="Manifestations">
