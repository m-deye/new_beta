...
const Consultations = () => {
  ...
  //   const fetchOffres = () => {
  //     fetch("http://127.0.0.1:8000/appels_offres/liste_type/?type=Consultations")
    ...
    const fetchOffres = async () => {
      try {
        const response = await axiosInstance.get(
          `/appels_offres/liste_type/?type=consultations&lang=${i18n.language}`
        );
