    ...
    const fetchAppel = async () => {
      try {
        const response = await axiosInstance.get(
          `/avis_infos/detail/${id}/?lang=${i18n.language}`
        );
        setAppel(response.data);
        if (!hasViewed.current) {
          await axiosInstance.post(
            `/avis_infos/incremente/${id}/incremente_vue/`
          );
              ...
              <div>
                ...
                >
                  ...
                  <a
                    ...
                    href={`/annonces_avisinfos/${appel.client__nom}`}
                    style={{
                      textDecoration: "none", // Ajout de text-decoration: none
                      backgroundColor: "#4E73DF", // Ajout de la couleur de fond
                    }}
