...
class Command(BaseCommand):
    help = 'Met à jour les noms des permissions avec des traductions en français'
    ...
    def handle(self, *args, **options):
        for permission in Permission.objects.all():
            ...
            if new_name and permission.name != new_name:
                ...
                permission.save()
                self.stdout.write(self.style.SUCCESS(f"Permission {permission.codename} mise à jour : {new_name}"))
            else:
                self.stdout.write(f"Permission {permission.codename} inchangée ou non trouvée dans les traductions")